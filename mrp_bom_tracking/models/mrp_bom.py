...
class MrpBom(models.Model):
    ...
    # producter_id = fields.Many2one('product.product', string='Product item')
    # product_uom_card = fields.Many2one(related='producter_id.uom_id', string='UOM on Item')
...
class MrpBomLine(models.Model):
    ...
    # producter_id = fields.Many2one('product.product', string='Product item')
    product_uom_card = fields.Many2one(related='product_id.uom_id', string='UOM on Item')
