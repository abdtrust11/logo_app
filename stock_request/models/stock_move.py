...
class StockMove(models.Model):
    ...
    request_line_id = fields.Many2one(
        ...
        string="Stock Requests Line")

    @api.depends("allocation_ids")
    def _compute_stock_request_ids(self):
        for rec in self:
            rec.stock_request_ids = rec.allocation_ids.mapped("request_line_id")
        ...
        for alloc in self.allocation_ids:
            default["allocation_ids"].append(
                (
                    ...
                    0,
                    {
                        "request_line_id": alloc.request_line_id.id,
    ...
    def _action_cancel(self):
        ...
        self.mapped("allocation_ids.request_line_id").check_done()
        return res
